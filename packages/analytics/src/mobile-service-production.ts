...
export class MobileAnalyticsServiceProduction extends BaseAnalyticsService {
  async initialize(config?: AnalyticsConfig): Promise<void> {
    ...
    try {
      ...
      this.log('Production mobile analytics initialized successfully');
    } catch (error) {
      this.warn('Production mobile analytics initialization failed', error);
